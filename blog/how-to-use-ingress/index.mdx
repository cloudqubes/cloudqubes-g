...
cover_image: "./k8s-ingress-cover.png"
cover_image_alt: "Thumbnail image for private git server"
slug: "how-to-use-ingress"
date: "2023-07-21"
categories: [hands-on]
tags: [Kubernetes]
---
...
![Kubernetes ingress - simplified](./k8s-ingress-simplified.png)
*Kubernetes ingress - simplified*

This is a simple representation of Kubernetes ingress. To learn how ingress works, you can read up on [Kubenetes ingress vs ingress controller](../ingress-vs-ingress-controller).
...
![Microk8s cluster](./k8s-ingress-microk8s.png)
*MicroK8s cluster*
...
![number-crunch application](./k8s-ingress-number-crunch-app-only.png)
...
![number-crunch application deployment](./k8s-ingress-number-crunch-1-without-prefix.png)
...
![number-crunch application deployment](./k8s-ingress-number-crunch-1.png)
*number-crunch application deployment*
...
![number-crunch-2](./k8s-ingress-number-crunch-2.png)
*number-crunch-2*
...
![Capturing groups for number-crunch-2](./k8s-ingress-capturing-group.png)
