...
description: The complete guide to understand what is Kubernetes ingress, what is ingress controller, and why we need them.
cover_image: "./k8s-ingress-vs-ingress-controller.png"
cover_image_alt: "Thumbnail image for ingress vs ingress controller"
slug: "ingress-vs-ingress-controller"
date:   "2023-07-09"
categories: [insights]
tags: [Kubernetes]
---
...
![Ingress and Ingress Controller](./k8s-ingress-api-object.png)
*Ingress and Ingress Controller*
...
![Concept of an ingress controller](./k8s-ingress-controller-how.png)
...
![Ingress controller inside the cluster](./k8s-ingress-with-loadbalancer.png)
...
![Ingress controller outside the cluster](./k8s-ingress-outside-the-cluster.png)
