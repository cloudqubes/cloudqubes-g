...
![Pipeline detailed view](./jenkins-pipeline-detailed-view.png)
...
![Pipeline build history](./jenkins-pipeline-build-history.png)
...
![Pipeline build history](./jenkins-pipeline-cosole-output.png)
*Pipeline build history*
...
![Creating the Counter-app Pipeline](./counter-app-pipeline-1.png)
...
![Pipeline definition](./counter-app-pipeline-2.png)
*Pipeline definition*
...
![Git server credentials](./counter-app-pipeline-credentials.png)
...
![Git server credentials - private key](./counter-app-pipeline-credentials-2.png)
...
Try a docker build agent for jenkins
Can write a separate article on the type of build agents in Jenkins