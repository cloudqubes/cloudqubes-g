...
![Harbor registry and K8s cluster](/assets/images/harbor/harbor-setup.png)
...
![Harbor Web UI - Project list](/assets/images/harbor/harbor-webui-projects.png)
*Harbor Web UI - Project list*

Click on the project name `number-crunch` to access the project details.

![number-crunch repositories](/assets/images/harbor/harbor-web-ui-counter-app-repos.png)
