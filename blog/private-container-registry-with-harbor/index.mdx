...
description: Harbor can store your container images inside your data center. It's secure and quick even for 10GB+ images.
cover_image: "./harbor-cover.png"
cover_image_alt: "Thumbnail image for harbor private container registry"
date:  "2023-08-06"
slug: "private-container-registry-with-harbor"
categories: [hands-on]
tags: [DevOps, k8s]
---
...
![Harbor registry and K8s cluster](./harbor-setup.png)
...
![Harbor Web UI - Project list](./harbor-webui-projects.png)
*Harbor Web UI - Project list*

Click on the project name `number-crunch` to access the project details.

![number-crunch repositories](./harbor-web-ui-counter-app-repos.png)
...
![Number of pulls for a repository in Harbor project](./harbor-image-pulls.png)
*Number of Pulls*
