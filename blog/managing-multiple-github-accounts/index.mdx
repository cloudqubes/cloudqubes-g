...
description: Using SSH key-based authentication and SSH config file, you can easily push code from multiple GitHub accounts in the same computer.
date:  "2023-05-26"
cover_image: "./multiple-github-cover.png"
cover_image_alt: "Thumbnail image. Three GitHub logos in a row."
...
![Add new SSH key](./github-ssh-keys.png)
*Add new SSH Key*
...
![Add new SSH key](./add-new-ssh-key.png)
*Add new SSH Key*
