...
date:  "2021-06-24"
description: Get familiat with Docker with this hands-on guide.
categories: [handson]
cover_image: "./docker-and-containers-cover.png"
cover_image_alt: "Thumbnail image. Orange background. Text Docker and Containers written in white. An icon of a stack of containers."
...
![Docker Hub - NGINX](./docker-hub-nginx.png)
