...
description: Thinking on using a NoSQL database for your next app. Do not conclude until you have read this article.
date:  "2022-11-03"
cover_image: "./sql-vs-nosql-cover.png"
cover_image_alt: "Thumbnail image. Kubernetes logo and text Kubernetes for absolute beginners."
slug: "how-to-choose-the-best-database"
...
![Relational model](./what-is-the-best-database/relational-model.png)
...
![Key-value model](./what-is-the-best-database/key-value-model.png)
*Key-Value model*
...
![Document data model](./what-is-the-best-database/document-model.png)
*Document data model*
...
![Wide-column data model](./what-is-the-best-database/wide-column-model.png)
...
![Graph data model](./what-is-the-best-database/graph-model.png)
*Graph data model*
...
![Time series data model](./what-is-the-best-database/time-series-model-1.png)
...
![Time series data model](./what-is-the-best-database/time-series-model-2.png)
...
![Search engine database](./what-is-the-best-database/search-engine-database.png)
