...
description: This article will help you grasp the basic concepts of Kubernetes and will also make you familiar with the jargon.
date:  "2022-11-26"
cover_image: "./kubernetes-beginner-cover.png"
...
![Workloads and pods in a Kubernetes cluster](./kubernetes-pods.png)
...
In the [next article](/blog/running-applications-in-Kubernetes), we will talk more about configuration files and managing workloads in Kubernetes.
