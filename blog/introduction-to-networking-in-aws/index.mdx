...
date:  "2022-10-07"
description: An introduction to the fundamentals and concepts in networking in AWS.
cover_image: "./aws-networking-cover.png"
cover_image_alt: "Thumbnail image with text Networking in AWS written in written in red-brown."
...
![Availability zones](./blog-aws-availability-zones.png)
*Availability zones*
...
![Public and private subnets in a VPC](./blog-aws-public-and-private-subnets.png)
