---
layout: post
title:  "All about Availability Zones and Host Aggregates in OpenStack"
description: You can use OpenStack availability zones and host aggregates to deploy applications more resiliently.
date:  "2020-11-12"
categories: [handson, OpenStack]
cover_image: "./availability-zones-and-host-aggregated-cover.png"
cover_image_alt: "Thumbnail image. OpenStack logo. Text Availability zones and host aggregagtes written in black on a white background."
slug: "introduction-to-networking-in-aws"
tags: [OpenStack]
---


The *availability zones* and *host aggregates* are familiar terms in OpenStack, but often lead to confusion and misuse. Rightly used, they can help efficient utilization of computing resources.
...
![Grouping computes with Avaialbility zones and host aggregates](./host-grouping-with-az-and-ha.png)
...
![Using availability zones for redundancy.](./leaf-spine-az.png)
...
![Using availability zones with host aggregates.](./leaf-spine-az-hg.png)
